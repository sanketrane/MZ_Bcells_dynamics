...
stan_file = os.path.join('/home/apoorva/Desktop/work/MZ_analysis/stan_models/new_models/Ontogeny/Spline Fits /T1_emp_func.stan')
...
data_file = os.path.join('/home/apoorva/Desktop/work/MZ_analysis/data/New_data/data_T1fits.json')
...
with open('/home/apoorva/Desktop/work/MZ_analysis/data/emperical_fit_T1.pkl', 'wb') as f:
    pkl.dump(fit, f)
