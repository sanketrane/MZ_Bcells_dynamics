...
stan_file = os.path.join('/Users/apoorvasingh/Desktop/MZB-new-analysis/stan_models/Ontogeny/DDM Influx/T2 Precursor/DDdivision_dependent.stan')
...
init_dict = {'rho': 0.02, 'phi': 0.01, 'r_phi': 30, 'M_stable': 2485012, 'K': 2585012, 'sigma': 0.5}
...
with open('/home/apoorva/Desktop/work/MZ_analysis/data/New output (pkl)/Ontogeny Output/DDM/T2 Precursor/DDM_T2_Division_dependentvaryinfluwithtime_check1.pkl', 'wb') as f:
    pkl.dump(fit, f)
