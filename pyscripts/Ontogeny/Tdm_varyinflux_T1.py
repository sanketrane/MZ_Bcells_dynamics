...
stan_file = os.path.join('/home/apoorva/Desktop/work/MZ_analysis/stan_models/new_models/Ontogeny/Mz_ontogenyT1.influxTDM_hillfunc.stan')
...
data_file = os.path.join('/home/apoorva/Desktop/work/MZ_analysis/data/newdata_mzontogenyT1.json')
...
with open('/home/apoorva/Desktop/work/MZ_analysis/data/Ontogeny_TDM_T1_varyinflux.pkl', 'wb') as f:
    pkl.dump(fit, f)
