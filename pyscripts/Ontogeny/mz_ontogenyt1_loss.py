...
stan_file = os.path.join('/home/apoorva/Desktop/work/MZ_analysis/stan_models/Ontogeny/DDM Influx/T2 Precursor/DDloss_independent.stan')
...
fit = model.sample(data=data_file, output_dir='/home/apoorva/Desktop/work/MZ_analysis/new_output',show_console=True, iter_sampling= 2000, iter_warmup= 100, chains=4, threads_per_chain=12)
...
with open('/home/apoorva/Desktop/work/MZ_analysis/data/New output (pkl)/Ontogeny Output/DDM/T2 Precursor/DDM_T2_Loss_independent.pkl', 'wb') as f:
    pkl.dump(fit, f)
