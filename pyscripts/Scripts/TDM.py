...
def main(stan_file, data_file, output_dir, model_name):
    ...
    fit = model.sample(data=data_file, output_dir=output_dir, show_progress=True,
                       show_console=False, iter_sampling=300, iter_warmup=100, chains=5,
                      threads_per_chain=3, max_treedepth=20, adapt_delta=0.99)
    ...
    output_file = os.path.join('/home/apoorva/Desktop/work/MZ_analysis/data/New output (pkl)/Steady State/TDM', f'{model_name}.pkl')
...
if __name__ == "__main__":
    ...
    parser.add_argument('--stan_file', type=str, required=True, help='Path to the Stan model file.')
