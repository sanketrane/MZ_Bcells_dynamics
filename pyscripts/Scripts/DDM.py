...
def main(stan_file, data_file, output_dir, model_name):
    ...
    fit = model.sample(data=data_file, output_dir=output_dir, show_progress=True,
                       show_console=False, iter_sampling=200, iter_warmup=100, chains=5,
                       parallel_chains=5, threads_per_chain=5, max_treedepth=20, adapt_delta=0.99)
    ...
    output_file = os.path.join('/home/apoorva/Desktop/work/MZ_analysis/data', f'{model_name}.pkl')
